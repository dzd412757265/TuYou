...
#import "UIMessagePhotoImageView.h"

@implementation UIMessagePhotoImageView
...
- (void)drawRect:(CGRect)rect {
    ...
    CGRect imageRect = CGRectMake(3, 3, rect.size.width - 6, rect.size.height - 6);
    [self.messagePhoto drawInRect:imageRect];
    
    CGFloat width = rect.size.width;
    CGFloat height = rect.size.height;//莫名其妙会出现绘制底部有残留 +1像素遮盖
